...
public class RconUtils {
    ...
    public static void err(String initiator, String message, Object... args) {
        System.err.printf((initiator != null ? "#%s>> " : "") + "%2$s", initiator, String.format(message, args));
    }
    ...
    public static byte[] merge(byte[] array1, byte[] array2) {
        Objects.requireNonNull(array1, "argument array1 must not null");
        Objects.requireNonNull(array2, "argument array2 must not null");
    ...
    public static void put(String initiator, String message, Object... args) {
        System.out.printf((initiator != null ? "#%s>> " : "") + "%2$s", initiator, String.format(message, args));
    }
     ...
     */
    public static int read(InputStream inputStream, byte buffer[]) {
        int i = 0;
    ...
    public static void say(String initiator, String message, Object... args) {
        if (RemoteController.isVerbose() || !RemoteController.isSilent()) {
            RconUtils.put(initiator, message, args);
        }
    }
    ...
    public static void verbose(String initiator, String message, Object... args) {
        if (RemoteController.isVerbose()) {
            RconUtils.put(initiator, message, args);
        }
    }
